...
#### 1. 🗡️ **Guerrero (Warrior)**
- **Filosofía**: "La fuerza viene del entrenamiento constante"
- **Quirks Únicos**:
  - `Iron Will` - Resistencia mental aumentada
  - `Battle Fury` - Daño aumenta con la salud perdida
  - `Weapon Master` - Dominio de múltiples armas
- **Progresión**: Entrenamientos físicos, deportes, disciplina
- **Estadísticas Base**: ATK +3, DEF +2, HP +5

#### 2. 🔮 **Mago (Mage)**
- **Filosofía**: "El conocimiento es el poder supremo"
- **Quirks Únicos**:
  - `Arcane Intellect` - Experiencia de estudio multiplicada
  - `Mana Overflow` - MP regenera más rápido
  - `Spell Weaver` - Combina habilidades mágicas
- **Progresión**: Lectura, estudio, investigación, aprendizaje
- **Estadísticas Base**: INT +4, MP +6, MAG +3

#### 3. 🏹 **Arquero (Archer)**
- **Filosofía**: "La precisión supera a la fuerza bruta"
- **Quirks Únicos**:
  - `Eagle Eye` - Críticos más frecuentes
  - `Wind Walker` - Velocidad aumentada
  - `Multi Shot` - Ataques múltiples
- **Progresión**: Actividades de precisión, deportes de puntería
- **Estadísticas Base**: DEX +4, SPD +3, LUK +2

#### 4. 🗡️ **Asesino (Assassin)**
- **Filosofía**: "Las sombras son mi aliado"
- **Quirks Únicos**:
  - `Shadow Step` - Evasión aumentada
  - `Poison Blade` - Daño continuo
  - `Stealth Master` - Ataques sorpresa
- **Progresión**: Actividades sigilosas, estrategia, planificación
- **Estadísticas Base**: SPD +4, DEX +3, LUK +3

#### 5. ⚡ **Paladín (Paladin)**
- **Filosofía**: "Proteger a otros es mi propósito"
- **Quirks Únicos**:
  - `Divine Shield` - Protección grupal
  - `Healing Light` - Curación mejorada
  - `Righteous Fury` - Daño vs enemigos malvados
- **Progresión**: Ayudar a otros, voluntariado, actos de bondad
- **Estadísticas Base**: DEF +4, HP +4, RES +3

#### 6. 📚 **Erudito (Scholar)**
- **Filosofía**: "El análisis revela todas las verdades"
- **Quirks Únicos**:
  - `Tactical Mind` - Bonos de estrategia
  - `Quick Learner` - EXP aumentada
  - `Weakness Scan` - Revela debilidades enemigas
- **Progresión**: Investigación, análisis, resolución de problemas
- **Estadísticas Base**: INT +3, WIS +4, MP +3
